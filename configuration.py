...
def load_application_config(base_dir, require_local=True):
    ...
    return {
        ...
        'DEEPSEEK_MODEL': _env_str('DEEPSEEK_MODEL'),
        'DEEPSEEK_TIMEOUT_SECONDS': _env_int('DEEPSEEK_TIMEOUT_SECONDS', 180),
        'DEEPSEEK_MAX_OUTPUT_TOKENS': _env_int('DEEPSEEK_MAX_OUTPUT_TOKENS', 4096),
        'DEEPSEEK_JSON_RETRIES': _env_int('DEEPSEEK_JSON_RETRIES', 1),
        'DEEPSEEK_WORKER_CONCURRENCY': _env_int('DEEPSEEK_WORKER_CONCURRENCY', 1),
        'DEEPSEEK_DEFAULT_EWMA_SECONDS': _env_float('DEEPSEEK_DEFAULT_EWMA_SECONDS', 45),
        ...
        'GEMINI_MODEL': _env_str('GEMINI_MODEL'),
        ...
        'GEMINI_JSON_RETRIES': _env_int('GEMINI_JSON_RETRIES', 1),
        'GEMINI_WORKER_CONCURRENCY': _env_int('GEMINI_WORKER_CONCURRENCY', 1),
        'GEMINI_DEFAULT_EWMA_SECONDS': _env_float('GEMINI_DEFAULT_EWMA_SECONDS', 50),
        ...
        'RABBITMQ_DEEPSEEK_QUEUE': _env_str(
            'RABBITMQ_DEEPSEEK_QUEUE',
            'deepseek_processing',
        ),
        'RABBITMQ_GEMINI_QUEUE': _env_str(
            'RABBITMQ_GEMINI_QUEUE',
            'gemini_processing',
        ),
