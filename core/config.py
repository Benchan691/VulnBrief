...
from core.prompts import DEFAULT_PROMPTS, merge_prompts
...
def load_application_config(base_dir):
    ...
    return {
        ...
        'ACCOUNT_HUB_TIMEOUT_SECONDS': _resolve(
            'ACCOUNT_HUB_TIMEOUT_SECONDS',
            file_config,
            ('account_hub', 'timeout_seconds'),
            5,
            int,
        ),
        ...
        'SMTP_PASSWORD': os.environ.get('SMTP_PASSWORD') or _dig(file_config, 'smtp', 'password') or '',
        'SMTP_FROM': _resolve('SMTP_FROM', file_config, ('smtp', 'from'), ''),
        'SMTP_USE_TLS': _resolve('SMTP_USE_TLS', file_config, ('smtp', 'use_tls'), True, bool),
        'SMTP_USE_SSL': _resolve('SMTP_USE_SSL', file_config, ('smtp', 'use_ssl'), False, bool),
    }
