(function () {
    const {
        jobsUrl,
        purgeEvidenceCacheUrl,
        purgeSearchCacheUrl,
        cancelUrlTemplate,
        deleteUrlTemplate,
        logsUrlTemplate,
        translationsUrlTemplate,
